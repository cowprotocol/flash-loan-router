...
library PermitHash {
    ...
    function hash(ISignatureTransfer.PermitTransferFrom memory permit, address spender) internal pure returns (bytes32) {
    ...
    function hash(ISignatureTransfer.PermitBatchTransferFrom memory permit, address spender) internal pure returns (bytes32) {
